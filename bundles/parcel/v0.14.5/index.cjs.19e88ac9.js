...
(function($PS) {
    ...
    var freeApplicative = {
        pure: function($121) {
            return fromView(Return1.create($121));
        },
        Apply0: function() {
            return freeApply;
        }
    ...
    var foldFree = function(dictMonadRec) {
        return function(k) {
            var go = function(f) {
                ...
                if (v instanceof Bind1) return Data_Functor.map(dictMonadRec.Monad0().Bind1().Apply0().Functor0())(function($135) {
        ...
        bimap: function(f) {
            return function(g) {
                return unGraft(function(v) {
                    return graft(new Graft1(function($57) {
...
(function($PS) {
    ...
    var render = function(state) {
        return Halogen_HTML_Elements.div_([
            Halogen_HTML_Elements.p_([
                Halogen_HTML_Core.text("You clicked " + (Data_Show.show(Data_Show.showInt)(state.count) + " times"))
            ]),
            Halogen_HTML_Elements.button([
                Halogen_HTML_Events.onClick(function(v) {
                    return Increment1.value;
                })
            ])([
    ...
    var handleAction = function(v) {
        return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function(st) {
            ...
            for(var $7 in st)if (({
            }).hasOwnProperty.call(st, $7)) $6[$7] = st[$7];
